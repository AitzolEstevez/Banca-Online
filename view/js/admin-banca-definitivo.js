...
function BancaOnlineload(cuentas) {
    ...
    newRow3 += "<!-- Button trigger modal -->"
        ...
        + "<h3 style='margin-bottom:60px; margin-top:20px; margin-left:25px; color:white;'>Cuenta1</h3>"
        + "<select style='margin-bottom:60px;' class='form-control' disabled id='Trans1'></select>"
        + "</div>"
        ...
        + "<h3 style='margin-bottom:60px; margin-top:20px; margin-left:25px; color:white;'>Cuenta2</h3>"
        + "<select style='margin-bottom:60px;' class='form-control' id='Trans2'></select>"
        + "</div>"
        + "</div>"
        + "<div id='importeinput'>"
        + "<h3>Importe</h3>"
